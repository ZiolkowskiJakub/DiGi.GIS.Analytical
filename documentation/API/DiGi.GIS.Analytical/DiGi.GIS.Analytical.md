...
The distance tolerance for geometric calculations\. A footprint whose area is below it cannot carry a floor, and the method then returns null rather than a model of walls with no floor or roof\.
