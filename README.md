...
**DiGi.GIS.Analytical** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.Analytical](DiGi.GIS.Analytical)** (Path: `DiGi.GIS.Analytical\DiGi.GIS.Analytical`)
